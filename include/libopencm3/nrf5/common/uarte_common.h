...
@ingroup uarte_defines
@{*/
#define UARTE_INTEN_CTS_Enabled                 (1 << 0)
#define UARTE_INTEN_NCTS_Enabled                (1 << 1)    
#define UARTE_INTEN_RXDRDY_Enabled              (1 << 2)    
#define UARTE_INTEN_ENDRX_Enabled               (1 << 4)
#define UARTE_INTEN_TXDRDY_Enabled              (1 << 7)
#define UARTE_INTEN_ENDTX_Enabled               (1 << 8)
#define UARTE_INTEN_ERROR_Enabled               (1 << 9)    
#define UARTE_INTEN_RXTO_Enabled                (1 << 17)
#define UARTE_INTEN_RXSTARTED_Enabled           (1 << 19)
#define UARTE_INTEN_TXSTARTED_Enabled           (1 << 20)
#define UARTE_INTEN_TXSTOPPED_Enabled           (1 << 22)
/**@}*/

...
@ingroup pwm_defines
@{*/
#define PWM_SHORTS_SEQEND0_STOP_Enabled               (1 << 0)
#define PWM_SHORTS_SEQEND1_STOP_Enabled               (1 << 1)
#define PWM_SHORTS_LOOPSDONE_SEQSTART0_Enabled        (1 << 2)
#define PWM_SHORTS_LOOPSDONE_SEQSTART1_Enabled        (1 << 3)
#define PWM_SHORTS_LOOPSDONE_STOP_Enabled             (1 << 4)
/**@}*/
